        ...
        <header>
            ...
            <div class="buttons flex justify-center">
                ...
                <div class="flex w-full max-w-md justify-between"> <!-- Limita el ancho para centrar correctamente -->
                    ...
                    <a href="../index.php" class="flex-1 text-center  bg-white hover:bg-gray-200 transition-all underline header-nav">

                        <div>STUDIO</div>

                    </a>

                    <a href="../products.php" class="flex-1 text-center  bg-white hover:bg-gray-200 transition-all underline header-nav">

                        <div>PRODUCTS</div>

                    </a>

                    <a href="../artwork.php" class="flex-1 text-center  bg-white hover:bg-gray-200 transition-all underline header-nav">
        ...
        <div class="products-margin">
            ...
            <div class="arrow-products">
                ...
                <div class="text-container-slide">
                    ...
                    <p class="card-title">TRABAJOS EN</p>

                    <p class="card-subtitle">CERAMICA</p>
            ...
            <div class="grid-products">
                ...
                <div class="card-container">
                    ...
                    <img src="../assets/img/products/ceramica/IMG_7506 copia.webp" alt="Product 1" class="h-auto" loading="lazy">
                ...
                <div class="card-container">
                    ...
                    <img src="../assets/img/products/ceramica/IMG_7510.webp" alt="Product 2" class="h-auto" loading="lazy">
                ...
                <div class="card-container">
                    ...
                    <img src="../assets/img/products/ceramica/IMG_8169.webp" alt="Product 3" class="h-auto" loading="lazy">
        ...
        <div>
            ...
            <div class="grid-products">
                ...
                <div class="card-container">
                    ...
                    <img src="../assets/img/products/ceramica/IMG_7512.webp" alt="Product 1" class="h-auto" loading="lazy">
                ...
                <div class="card-container">
                    ...
                    <img src="../assets/img/products/ceramica/IMG_9700.webp" alt="Product 2" class="h-auto" loading="lazy">
                ...
                <div class="card-container">
                    ...
                    <img src="../assets/img/products/ceramica/IMG_9742.webp" alt="Product 3" class="h-auto" loading="lazy">
        ...
        <div>
            ...
            <div class="grid-products">
                ...
                <div class="card-container">
                    ...
                    <img src="../assets/img/products/ceramica/IMG_7563.webp" alt="Product 1" class="h-auto" loading="lazy">
                ...
                <div class="card-container">
                    ...
                    <img src="../assets/img/products/ceramica/IMG_9735.webp" alt="Product 2" class="h-auto" loading="lazy">
                ...
                <div class="card-container">
                    ...
                    <img src="../assets/img/products/ceramica/IMG_9713.webp" alt="Product 3" class="h-auto" loading="lazy">
