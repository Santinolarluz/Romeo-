...
<head>
  ...
  <title>Romeo Sosa - Art and Furniture Studio in Buenos Aires</title>
  <link rel="icon" href="/assets/img/favicon.ico" type="image/x-icon">
  <meta name="description" content="Explore Romeo Sosa's unique brutal and sophisticated art pieces in his studio in Buenos Aires. Discover furniture and art that blends industrial materials with artistic craftsmanship.">
  <meta property="og:title" content="Romeo Sosa - Art and Furniture Studio in Buenos Aires">
  <meta property="og:description" content="Discover Romeo Sosa's unique art pieces and furniture in his Buenos Aires studio. Visit us and explore brutal yet sophisticated designs.">
  <meta property="og:image" content="assets/img/Romeo.png">
  <meta property="og:url" content="https://romeososa.com">
...
<body>
  ...
  <div class="container mx-auto container-custom">
    ...
    <header>
      ...
      <div class="buttons flex justify-center">
        ...
        <div class="flex w-full max-w-md justify-between"> <!-- Limita el ancho para centrar correctamenteSS -->
          ...
          <a href="products.php" class="flex-1 text-center  bg-white hover:bg-gray-200 transition-all  header-nav">
    ...
    <a href="index.php">
      <div class="slide-romeo">
        <img src="assets/img/Romeo.png">
      </div>
    </a>

    <div class="flex ig-head ig-headhome">

      <p class="font-bold text-xs text-hero"><a href="https://www.instagram.com/romeososaig/">@ROMEOSOSAIG </a></p>
    ...
    <div class="window video-container" id="videoWindow6">
      <div class="title-bar">
        <div class="title-bar-text">studio (1).mp4</div>
    ...
    <div class="full-width-image">
      <img src="assets/img/image00001.jpeg">
    </div>
    ...
    <div class="text-home text-products text-home-2">
      ...
      <div class="">
        ...
        <div class="container text-container mb-4 md:mb-0">
          ...
          <p>Creemos que la potencia de los espacios comienza poniendo a las personas como columna principal para entender el habitar de las mismas y diseñar en función de sus necesidades.
            Desarrollamos interiorismo comercial y particular.
          </p>
    ...
    <div class="full-width-image">
      <img src="assets/img/image00002.jpeg">
    </div>
    ...
    <div class="text-home text-products text-home-2">
      ...
      <div class="">
        ...
        <div class="container text-container mb-4 md:mb-0">
          ...
          <p>
            La exploración con el diseño como herramienta, nos conduce al entendimiento del comportamiento humano con el objetivo de mejorar la calidad de vida y así lograr bienestar.
          </p>
    ...
    <div class="full-width-image">
      <img src="assets/img/image00003.jpeg">
    </div>
  ...
  <script>
    // Initialize Flickity for the first slider without pagination and arrows
  ...
  <script>
    document.getElementById('contactForm').addEventListener('submit', function(event) {
      ...
      fetch('contact.php', {
        ...
        .then(data => {
          // Mostrar el mensaje en el div formAlert
          var alertDiv = document.getElementById('formAlert');
          alertDiv.innerHTML = '<div class="bg-green-200 text-green-800 p-2 rounded">' + data + '</div>';
        })
        .catch(error => {
          var alertDiv = document.getElementById('formAlert');
          alertDiv.innerHTML = '<div class="bg-red-200 text-red-800 p-2 rounded">Error al enviar el mensaje. Intente más tarde.</div>';
        });
    });
  </script>
  ...
  <script>
    document.querySelector('form').addEventListener('submit', function(event) {
      ...
      if (!emailField.value.includes('@') || isNaN(phoneField.value)) {
        alert('Por favor, proporcione un correo electrónico y un número de teléfono válidos.');
